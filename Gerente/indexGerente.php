...
<head>
	...
	<link rel="stylesheet" href="../css/estilosGer.css">
      ...
      <div class="logo-menu">
        <div class="container">
          <div class="row middle-xs between-xs">
            ...
            <nav class="menu col-xs-12 col-sm-7 center-xs end-sm">
              <a href="../Gerente/indexGerente.php">Inicio</a>
        ...
        <div class="container">
          <div class="row center-xs">
            <div class="col-xs">
              <nav>
                <a href="indexGerente.php">Servicios</a>
                <a href="../Gerente/Reporte/Reportes.php">Reportes</a>
              </nav>
            </div>
          </div>
        </div>

      ...
      <div class="logo-menu">
        <div class="container">
          <div class="row middle-xs between-xs">
            ...
            <nav class="menu col-xs-12 col-sm-7 center-xs end-sm">
              <a href="../Admin/indexAdmin.php">Inicio</a>
        ...
        <div class="container">
          <div class="row center-xs">
            <div class="col-xs">
              <nav>
                <a href="indexAdmin.php">Servicios</a>
                <a href="Registro.php">Registrar Usuario</a>
                <a href="../Admin/Reportes/Reportes.php">Bitácora</a>
                <a href="../Admin/Solicitudes/Solicitudes.php">Reportes</a>
              </nav>
            </div>
          </div>
        </div>
        ...
        <div class="row around-xs">
		 <div class="contenedor">
		      ...
		      <div class="contenedor_tarjeta">
		         <a href="../Admin/Servicios/Mantenimiento.php">
				    <figure id="tarjeta">
			  ...
			  <div class="contenedor_tarjeta">
		         <a href="../Admin/Servicios/ReparacionSw.php">
				    <figure id="tarjeta">
			  ...
			  <div class="contenedor_tarjeta">
		         <a href="../Admin/Servicios/ReparacionHw.php">
				    <figure id="tarjeta">
			  ...
			  <div class="contenedor_tarjeta">
		         <a href="../Admin/Servicios/DeteccionV.php">
				    <figure id="tarjeta">
			  ...
			  <div class="contenedor_tarjeta">
		         <a href="../Admin/Servicios/InstalSw.php">
				    <figure id="tarjeta">
